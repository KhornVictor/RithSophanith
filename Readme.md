...
<div style="display: flex; flex-direction: column; gap: 16px; align-items: center;">
  ...
  <img style="width: 200px; height:200px" src="https://miro.medium.com/v2/resize:fit:1400/1*ev27A-gMNB4BHKljNl-uHA.gif">
</div>

<p align="center">
  A girl in tech who enjoys turning ideas into useful products.
  <br/>
  I care about clean logic, thoughtful design, and constant growth.
</p>

<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Playfair+Display&size=24&pause=1200&color=F783AC&center=true&vCenter=true&width=700&lines=Elegant+code+is+kind+code.;Learning+every+day%2C+shipping+every+week.;Building+my+future+one+project+at+a+time." alt="Typing banner" />
</div>
...
- Currently learning deeper frontend architecture and system thinking
- Love building web interfaces that feel simple, calm, and useful
- Interested in open-source collaboration and real-world projects
- Long-term goal: become a strong software engineer with product sense

### Focus This Year

```txt
1) Write cleaner and more maintainable code
2) Build portfolio projects with real impact
3) Improve algorithms and problem-solving speed
4) Grow communication and teamwork skills
```
...
<div align="left">
  <a href="https://web.facebook.com/khorn.chanvictor/" target="_blank">
...
<div align="center">
  <sub>Designed with heart, discipline, and curiosity.</sub>
</div>
